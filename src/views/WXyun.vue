<template>
  <div class="wxyun">
    <div>&nbsp;</div>
    <div class="title">
      <h1>腾讯犀牛鸟云开发线下工坊竞技赛要来啦！！！</h1>
    </div>
    <article>

      <img src="../assets/wxyun/logo.png" width="500px"/><br/>
      <p>
        腾讯“犀牛鸟精英人才培养计划”于2017年发布，旨在打造面向学生的校企联合培养方案，构建产学研合作良好人才生态，培养海内外顶尖人才，加速前沿技术的应用转化。犀牛鸟精英人才培养计划自2017年发布以来，共收到50余所高校的近300名优秀学生申请，其中近80名学生入选，并进入腾讯开展科研访问，基于真实产业问题，借助腾讯海量数据、专家指导等资源，验证学术理论，加速成果应用转化，全面提升自身科研能力和综合素质。
        详情请见: <a href="https://ur.tencent.com/talent/program" target="_blank" rel="noopener">腾讯犀牛鸟人才培养计划</a>。
      </p>
      ...
      <h2>学生项目的参与方式是？</h2>
      <img src="../assets/tstar/divider.png" alt="title"/><br/>
      <ol style="text-align: left; font-size: 1.3rem; margin: 20px 2em">
        <li>通过本校腾讯创新俱乐部进行报名。</li>
        <li>参与俱乐部及腾讯高校合作、腾讯云组织的线下小程序云开发工坊(即：腾讯云开发达人计划)。</li>
        <li>线上提交作品、参与竞技赛。</li>
      </ol>
      ...
      <ul style="text-align: left; font-size: 1.3rem; margin: 20px 2em">
        <li>腾讯云一线业务大咖讲解答疑</li>
        <li>专业导师的课程和技术支持服务</li>
        <li>参与以实战为目标的免费小程序课程</li>
        <li>系统的云开发课程培训，专属的技术培训</li>
        <li>赢取腾讯全球数字产业大会门票</li>
        <li>有机会获得鹅厂实习/正式offer</li>
        <li>优秀的开发者有机会参与云开发101开发者计划</li>
        ......
      </ul>
      ...
      <img src="../assets/wxyun/wxyun-qqun.jpg" alt="gzh" width="275px" style="margin-left: 50px"/><br/>
